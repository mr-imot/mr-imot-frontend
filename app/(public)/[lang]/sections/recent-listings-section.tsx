        ...
        <div className="relative">
          {isLoadingListings ? (
            <div className="flex gap-6 overflow-x-auto pb-2">
              {[1,2,3,4,5,6].map((i) => (
                <div key={i} className={`min-w-[340px] max-w-[360px] lg:min-w-[400px] lg:max-w-[400px] ${cardStyles.card} p-4 animate-pulse`}>
            ...
            <div className={`flex gap-6 lg:gap-8 overflow-x-auto snap-x snap-mandatory pb-4 ${effectsStyles.edgeFadeL} ${effectsStyles.edgeFadeR} scrollbar-medium`} style={{ scrollSnapType: 'x mandatory' }}>
              {(recentListings.slice(0, 5)).map((listing) => (
                ...
                >
                  <article className={`${cardStyles.card} p-4 hover:-translate-y-1 transition-transform cursor-pointer h-full`}>
