...
interface LocalizedDevelopersPageProps {
  dict: any
  lang: 'en' | 'bg'
}

export function LocalizedDevelopersPage({ dict, lang }: LocalizedDevelopersPageProps) {
            ...
            <>
                      ...
                      <CardContent className="p-0 flex flex-col h-full">
                        ...
                        <div className="p-6 flex flex-col flex-grow">
                          ...
                          <Button asChild className="w-full mt-auto">
                            <Link href={href(`developers/${developer.id}`, `developers/${developer.id}`)}>
              ...
              {pagination && pagination.total_pages > 1 && (
                <div className="mt-8 text-center text-muted-foreground">
                  <p>{dict.developers.showingResults.replace('{{count}}', developers.length.toString()).replace('{{total}}', pagination.total.toString())}</p>
                </div>
              )}
            </>
          ) : (
