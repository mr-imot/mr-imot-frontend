      ...
      <section className="py-16 md:py-24 lg:py-32 relative overflow-hidden">
        <div className="container mx-auto px-3 xs:px-4 sm:px-6 md:px-8">
          <div className="flex flex-col lg:grid lg:grid-cols-2 gap-4 sm:gap-6 md:gap-8 laptop:gap-8 lg:gap-12 items-center min-h-[50vh] sm:min-h-[60vh] md:min-h-[60vh] laptop:min-h-[70vh] lg:min-h-[80vh]">
            ...
            <div className="space-y-1 order-1 lg:order-none lg:col-span-1">
            ...
            <div className="pt-2 order-3 lg:order-none lg:col-span-1">
            ...
            {/* Video Container - Order 4 on mobile */}
            <div className="order-4 lg:order-none lg:col-span-1 lg:absolute lg:inset-0 lg:pointer-events-none">
            ...
            <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:gap-4 pt-3 sm:pt-4 order-5 lg:order-none lg:col-span-1">
              <Link href="/listings">
