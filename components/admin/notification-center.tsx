...
export function NotificationCenter({ pendingDevelopers = [] }: NotificationCenterProps) {
  ...
  const notificationTemplates = {
    verification_approved: {
      subject: 'Акаунт потвърден - Добре дошли в Мистър Имот!',
      message: `Уважаеми {contact_person},

Радваме се да ви информираме, че вашият акаунт за {company_name} е успешно потвърден и одобрен.
...
Екипът на Мистър Имот`
    ...
    verification_rejected: {
      subject: 'Статус на заявката за акаунт',
      message: `Уважаеми {contact_person},

Благодарим ви за интереса да се присъедините към Мистър Имот като партньор инвеститор.
